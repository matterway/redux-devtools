...
- [react-native-debugger](https://github.com/jhen0409/react-native-debugger) - Electron app, which already includes `remotedev-server`, `matterway-redux-devtools-core` and even React DevTools.
...
import DevToolsApp from 'matterway-redux-devtools-core/lib/app';
