...
[![npm version](https://img.shields.io/npm/v/matterway-redux-slider-monitor.svg?style=flat-square)](https://www.npmjs.com/package/matterway-redux-slider-monitor)
...
[Try out the demo!](https://calesce.github.io/matterway-redux-slider-monitor/?debug_session=123)
...
`npm install matterway-redux-slider-monitor`
...
```
git clone https://github.com/calesce/matterway-redux-slider-monitor.git
cd matterway-redux-slider-monitor
npm install
